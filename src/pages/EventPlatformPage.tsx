...
const SAMPLE_EVENTS: EventRecord[] = [
  ...
  {
    id: 'sample-fde-night-seoul',
    title: 'Claude Code FDE Night Seoul',
    description: [
      'Claude Code를 활용한 FDE 워크플로우와 고객 대면 엔지니어링 경험을 나누는 기술 밋업입니다.',
      '',
      '18:30 체크인 & 네트워킹',
      '19:00 FDE 플레이북 세션',
      '19:30 실무자 파이어사이드 챗',
      '20:30 랩업 & 네트워킹',
      '',
      'FDE, 솔루션 엔지니어, 엔지니어링 리더, AI 스타트업 엔지니어에게 특히 잘 맞는 행사입니다.',
    ].join('\n'),
    category: 'conference',
    coverImageUrl: 'https://images.unsplash.com/photo-1591115765373-5207764f72e7?auto=format&fit=crop&w=1400&q=80',
    hostUserId: 'sample-claude-community',
    hostName: 'Claude Community Seoul',
    coHostName: 'AI Builders Korea',
    startsAt: '2026-07-17T18:30',
    endsAt: '2026-07-17T21:30',
    timezone: 'Asia/Seoul',
    eventType: 'offline',
    ...
    approvalMode: 'manual',
    dressCode: '캐주얼',
    giftNote: '가벼운 음식과 음료가 준비됩니다.',
    contactNote: '사전 등록제이며 신청 내용을 검토한 뒤 참가 확정 여부를 안내합니다.',
