import { IDTokenPayload } from './decodeIdTokenPayload';
...
export declare const INVALID_PAYLOAD = "Invalid payload in ID_TOKEN";
export declare function verifyIDToken(idToken: string, liffClientId: string): Promise<IDTokenPayload>;
